...
From Music Demixing Track Starter Kit, SDX 2023
...
class GlobalSDR(BaseMetric):
    ...
    def _metric(self, references, separations):
        ...
        separations = separations.cpu().detach().numpy()
...
def calc_metrics(target, estimated):
    metric = GlobalSDR()
    music_score = metric(target, estimated)
    return music_score
